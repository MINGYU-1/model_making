...
#x,x2,x3은 그냥 입력값
history = {'a': 9.972887394351094, 'b': 0.2850579569357288, 'c': 2.7213132264567905, 'd': 12.987850364311381, 'e': 0.21831316375889556, 'f': 0.1360006434644352, 'g': 0.18892902408005896}
def integrated_loss_fn(binary_logit, x_hat,x2_hat,x3_hat, x,x2,x3, mu, logvar,mu2,logvar2,mu3,logvar3):
    ...
    total_loss = (history['a']* mse_loss + history['b']*mse2_loss+ history['c']*mse3_loss + history['d'] * bce_loss 
    + history['e'] * kl_loss+history['f']*kl2_loss + history['g']*kl3_loss) / batch_size
