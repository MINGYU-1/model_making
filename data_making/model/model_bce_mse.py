...
hyper_dict = {'lr': 0.006766126204772056, 'z_dim': 21, 'alpha': 0.11166089758490058, 'beta': 0.03679915945155675, 'gamma': 0.14792382594314013}
## predictor 구하는방법
...
def integrated_loss_fn(mask_logits,recon_numeric, target_x, mu, logvar):
    ...
    loss = (hyper_dict['alpha']* masked_mse_loss + hyper_dict['beta']* bce_loss+hyper_dict['gamma']*kl_loss)/batch_size
